  ...
  return (
    <section className="pb-14 md:pb-20 px-4">
      <div className="max-w-[1280px] mx-auto">
        {/* <h1 className="font-belleza text-2xl sm:text-3xl lg:text-[34px]  text-[#2f2a28] uppercase mb-6 mt-3">
          {product.title}
        </h1> */}
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(500px,600px)_minmax(400px,620px)] gap-10 lg:gap-[60px]">
          ...
          <div className="lg:grid lg:grid-cols-[110px_minmax(300px,1fr)] lg:gap-5">
            <div className="relative w-full h-[77vh] sm:h-[50vh] md:h-[75vh] lg:h-[480px] order-1 lg:order-2 bg-[#fff] shadow-[0_4px_8px_#0000004d]  ">
              <Image
            ...
            <div className="order-2 lg:order-1 mt-4 lg:mt-0 flex gap-3 overflow-x-auto lg:flex-col lg:overflow-y-auto lg:h-[480px] [&::-webkit-scrollbar]:hidden [scrollbar-width:none]">
              {product.images?.map((img, idx) => (
                <div
                  ...
                  className={`relative w-[100px] h-[152px] sm:w-[110px] sm:h-[110px] lg:w-[110px] lg:h-[110px] flex-shrink-0 cursor-pointer  `}
                >
                  <Image
                    src={img}
                    fill
          ...
          <div className="flex flex-col justify-between px-0 gap-10">
            <div className="flex flex-col gap-6 px-2 lg:px-0">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-6 text-[12px] font-poppins text-[#42393B]">
